...
void on_correction_received(const uint8_t* data, size_t len, const uint8_t* src_mac) {
    //ESP_LOGI(TAG, "Received correction data from GS (%u bytes)", (unsigned)len);
...
extern "C" void app_main(void)
{
    ...
    xTaskCreate(Uart::rx_gngga_task, "uart_rx_gngga_task", 1024 * 8, NULL, configMAX_PRIORITIES - 2, NULL);
